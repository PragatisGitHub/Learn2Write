...
def load_model(Choice):
    ...
    if (Choice == "Alpha"):
        K.clear_session()
        model = keras.models.load_model("emnist/eminst_letters_cnn_par_model.h5")
    elif (Choice == "Num"):
        K.clear_session()
        model = keras.models.load_model("emnist/eminst_digits_cnn_par_model.h5")
...
#    print(Symbol)
    ...
    with graph.as_default():
        ...
        predicted = model.predict(image_array)[0]
